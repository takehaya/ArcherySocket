...
class allbaViewController: UIViewController,UITableViewDelegate {
    ...
    @IBOutlet weak var unwindreturn_to_mypagebutton: UIButton!
    ...
    override func viewDidLoad() {
        super.viewDidLoad()
       unwindreturn_to_mypagebutton.addTarget(self, action: "unwindreturn_to_mypagebuttonEvent:", forControlEvents: UIControlEvents.TouchUpInside)
    ...
    func unwindreturn_to_mypagebuttonEvent(sender:UIButton){
        self.socket.close()
    }
//アラートのボタンの関数
